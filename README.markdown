...
Built on top of [Idiorm](https://github.com/j4mie/idiorm/).
...
* Exposes the full power of [Idiorm](https://github.com/j4mie/idiorm/)'s fluent query API.
...
The documentation is hosted on Read the Docs: [paris.rtfd.org](https://paris.rtfd.org)
